  ...
  private async initializeSchema(): Promise<void> {
    ...
    try {
      ...
      const indexes = [
        ...
        'CREATE INDEX IX_Chats_LastMessageAt ON Chats(lastMessageAt DESC)',
        ...
        'CREATE INDEX IX_DatabaseConnections_Type ON DatabaseConnections(type)',
        'CREATE INDEX IX_DatabaseConnections_Status ON DatabaseConnections(status)',
        ...
        'CREATE INDEX IX_WorkspaceUsers_AccessLevel ON WorkspaceUsers(accessLevel)',
